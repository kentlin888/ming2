...
describe('others_1.test', () => {
    ...
    it('Object.Assign/Spreator/lodash', () => {
        ...
        console.log("LOG:: objAssign", objAssign)
        let operatorSep = {
            ...obj,
            phone: "09573213"
        }
        console.log("LOG:: operatorSep", operatorSep)
        let lodashObj = _.cloneDeep(obj)
        console.log("LOG:: lodashObj", lodashObj)
        let arr1 = [1, 3, 5, 7]
        let arr2 = ['A', ...arr1, 'B']
        console.log(arr2)
    })
    ...
    it('Array group ProductInfo', () => {
        ...
        let d2 = _(data).groupBy('category').map((arrayGroupedItems, category) => {
            ...
            // console.log('arrayGroupedItems-->',arrayGroupedItems)
            // return ''
            return{
                category,
                arrayGroupedItems
    ...
    it('Destructuring assignment', () => {
        ...
        // console.log(a)
        [a, b, ...rest] = array1
        console.log("LOG:: a", a) // 10
        console.log("LOG:: rest", rest) // 30, 40, 50
    })
