...
async function before() {
    const TIMEOUT = 9 * 10000000 // seconds
    ...
    let mm = By.css(`[data-testid='iptSignInEmail']`)
    ...
    let sElem = `document.querySelector("#modalLogin > div > div > div.modal-body > form.signInHtm.titleText > div:nth-child(1) > input[type=email]")`
    driver.executeScript(`${sElem}.value='CCC'`);
